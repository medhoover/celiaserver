 ...
 */
class Image extends \Med\CeliaBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Med\\CeliaBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'Med\\CeliaBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'Med\\CeliaBundle\\Entity\\Image' . "\0" . 'alt', '' . "\0" . 'Med\\CeliaBundle\\Entity\\Image' . "\0" . 'file', '' . "\0" . 'Med\\CeliaBundle\\Entity\\Image' . "\0" . 'tempFilename');
        }
    ...
    public function setTempFilename($tempFilename)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTempFilename', array($tempFilename));

        return parent::setTempFilename($tempFilename);
    }
